...
use crate::{
    ...
    device::{
        ...
        snd::{
            control,
            pcm::{
                DEV_BUFFER_BYTES, DEV_BUFFER_FRAMES, DEV_CHANNELS, DEV_PERIOD_BYTES, PcmStream,
                SNDRV_PCM_VERSION, SndPcmChannelInfo, SndXferi, ioctl_defs,
            },
        },
    },
    events::IoEvents,
