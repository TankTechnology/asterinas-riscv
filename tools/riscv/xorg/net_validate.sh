...
# Summarize the network outcome from the NetSurf serial log.
if   grep -qa 'Unknown cURL response code 7' "$log"; then res="code7"
...
elif grep -qa 'HTTP status code 200' "$log"; then res="http200"
