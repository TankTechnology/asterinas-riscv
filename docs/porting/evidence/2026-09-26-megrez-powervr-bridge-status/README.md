...
| `/lib/firmware/rgx.sh.30.3.408.101` | Not yet verified; the recorded digest had 41 hex digits and cannot be a SHA-256 digest. Recompute on the next RockOS boot before staging this file. |
