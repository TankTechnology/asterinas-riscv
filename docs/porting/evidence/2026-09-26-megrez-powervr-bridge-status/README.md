...
The reference software is RockOS `eswin-eic7x-gpu 24.2+0rockos3`, with
`libgbm1 1:22.3.5+1rockos1+0pvr2` and `libegl1`/`libgles2 1.7.0-1+b1`.
The pinned files on that installation are:

| File | SHA-256 |
| --- | --- |
| `/lib/firmware/rgx.fw.30.3.408.101` | `25e9e7ff4645292ceb991617dba028e350a5c17088a105230dbaaaf995f4413b` |
| `/lib/firmware/rgx.sh.30.3.408.101` | `9b7a9779c982ef3c29be2f77378c6b037fc264b978f9416eadc6cee553bba67b` |
...
The [bounded RockOS unload/reload experiment](../2026-09-26-megrez-powervr-task1-rockos-lifecycle/README.md)
recomputed the shader SHA-256 and recorded the GPU driver lifecycle.
