...
try:
    ...
    created = True
    for run, (width, height) in enumerate(((960, 540), (800, 450),
                                           (960, 540)), 1):
        ...
        for index, part in enumerate(parts):
            print(f'VIDEO_SIZE_CHUNK run={run} i={index} data={part}', flush=True)
        print(f'VIDEO_SIZE_END run={run} parts={len(parts)} '
