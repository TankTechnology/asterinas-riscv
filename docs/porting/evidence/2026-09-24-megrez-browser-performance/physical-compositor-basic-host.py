...
try:
    ...
    (root / 'physical-compositor-basic-guest-output.txt').write_text(output)
    chunks = {}
    endings = {}
    ...
    (root / 'physical-compositor-basic-result.json').write_text(json.dumps({
    ...
    (root / 'physical-compositor-basic-host-commands.json').write_text(json.dumps(records, indent=2))
    if serial is not None:
        (root / 'physical-compositor-basic-serial.log.gz').write_bytes(
